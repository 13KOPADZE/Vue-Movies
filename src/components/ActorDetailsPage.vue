<template>
    <div>
        ...
        <div class="background" :style="{ backgroundImage: `url(${'https://image.tmdb.org/t/p/w1280'+ results.profile_path})` }" v-if="results.profile_path !== undefined">
            <div class="movieDetails">
                <div class="actor-image">
                    <img v-bind:src="'https://image.tmdb.org/t/p/w500' + results.profile_path" v-if="results.profile_path !== null">
                ...
                <section class="informationSection">
                    ...
                    <div class="actor-info">
                        <div>
                            <h3>Imdb Id</h3>
                            <div class="imdb_id" v-if="results.imdb_id !== null"><a :href='ACTOR_IMDB_URL + results.imdb_id' target="_blank"><div style="color: #fff !important">{{results.imdb_id}}</div></a></div>
                            <p v-else>No Info</p>
                        </div>
        ...
        <div class="container paddingAround">
            ...
            <div class="grid" >
                <div class="gridElement movie-info" v-for='movie in movies' :key='movie.id'> 
...
import Vue from 'vue'
import {API_KEY, API_URL, IMG_W500, ACTOR_IMDB_URL, MOVIE_IMDB_URL} from '@/config'
